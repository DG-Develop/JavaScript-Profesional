...
var people = [];
people = ['David', 'Monica', 'Pedro']; //people.push(00)

var peopleAndNumbers = [];
peopleAndNumbers.push('Omar');
peopleAndNumbers.push('Elvira'); // Enum
...
var suma = add(4, 6); // regresar una funcion
