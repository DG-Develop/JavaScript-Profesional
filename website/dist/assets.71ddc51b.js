...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/@dgdevelop/mediaplayer/lib/MediaPlayer.js":[function(require,module,exports) {
"use strict";
...
},{}],"node_modules/@dgdevelop/mediaplayer/lib/plugins/Autoplay.js":[function(require,module,exports) {
"use strict";
exports.__esModule = true;
...
},{}],"node_modules/@dgdevelop/mediaplayer/lib/plugins/AutoPause.js":[function(require,module,exports) {
"use strict";
exports.__esModule = true;
var AutoPause = /** @class */ (function () {
    ...
    AutoPause.prototype.run = function (player) {
        this.player = player;
        var observer = new IntersectionObserver(this.handlerItersection, {
            threshold: this.threshold
        });
        observer.observe(this.player.media);
        document.addEventListener("visibilitychange", this.handleVisibilityChange);
    };
    AutoPause.prototype.handlerItersection = function (entries) {
        var entry = entries[0];
...
},{}],"node_modules/@dgdevelop/mediaplayer/lib/plugins/Ads/Ads.js":[function(require,module,exports) {
"use strict";
...
},{}],"node_modules/@dgdevelop/mediaplayer/lib/plugins/Ads/index.js":[function(require,module,exports) {
"use strict";
exports.__esModule = true;
...
},{"./Ads":"node_modules/@dgdevelop/mediaplayer/lib/plugins/Ads/Ads.js"}],"assets/index.ts":[function(require,module,exports) {
"use strict";
...
var mediaplayer_1 = __importDefault(require("@dgdevelop/mediaplayer"));

var Autoplay_1 = __importDefault(require("@dgdevelop/mediaplayer/lib/plugins/Autoplay"));

var AutoPause_1 = __importDefault(require("@dgdevelop/mediaplayer/lib/plugins/AutoPause"));

var Ads_1 = __importDefault(require("@dgdevelop/mediaplayer/lib/plugins/Ads")); // query selector agarra un tag o varios en este caso solo uno para video y otro para el boton
...
},{"@dgdevelop/mediaplayer":"node_modules/@dgdevelop/mediaplayer/lib/MediaPlayer.js","@dgdevelop/mediaplayer/lib/plugins/Autoplay":"node_modules/@dgdevelop/mediaplayer/lib/plugins/Autoplay.js","@dgdevelop/mediaplayer/lib/plugins/AutoPause":"node_modules/@dgdevelop/mediaplayer/lib/plugins/AutoPause.js","@dgdevelop/mediaplayer/lib/plugins/Ads":"node_modules/@dgdevelop/mediaplayer/lib/plugins/Ads/index.js","/home/dgdband/Documentos/Platzi/Profesional de JavaScript/Programas/profesional/website/sw.js":[["sw.js","sw.js"],"sw.js.map","sw.js"]}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "37421" + '/');
